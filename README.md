...
3) (title.ratings) Які 10 фільмів мають найбільший рейтинг, та який?
4) (title.ratings) Які 20 фільмів мають найбільшу кількість голосів, та яку?
5) (title.crew) Який(і) режисер(и) зняв(ли) найбільшу кількість фільмів?
6) (title.crew) Скільки режисерів були також і писали сценарій
